              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Text(
                      "Dana Pendidikan ${c.namaAnak.text}",
                ...
                SizedBox(
                  child: c.nomSisa.isNegative
                      ? Center(
                          child: Text(
                            "Dana Pendidikan Telah Tercapai!",
                            style: Theme.of(context)
                                .textTheme
                                .bodyMedium!
                                .copyWith(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                Text(
                                  "selama ${c.bulanTercapai.toInt()} bulan",
                                  style: Theme.of(context)
                                      .textTheme
                                      .bodySmall!
                                      .copyWith(
                            ...
                            Text(
                              "Agar perencanaan dana darurat dapat tercapai",
                              style: Theme.of(context)
                                  .textTheme
                                  .bodySmall!
                                  .copyWith(
