                    ...
                    children: [
                      ...
                      Text(
                        NumberFormat.currency(
                            ...
                            .format(c.danaHajiUmroh),
                        style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                              color: grey900,
                            ),
                      ),
                      Text(
                        "(Perkiraan inflasi 5% per tahun)",
                            ...
                            children: [
                              ...
                              RichText(
                                text: TextSpan(
                                  ...
                                  children: [
                                    const TextSpan(
                                      text: 'Perencanaan dana umroh/haji ',
                                    ),
                                    TextSpan(
                                      text: c.danaStat,
                                      style: TextStyle(
                              ...
                              Text(
                                "Agar perencanaan dana umroh/haji dapat tercapai",
                                style: Theme.of(context)
                                    .textTheme
                                    .bodySmall!
                                    .copyWith(
