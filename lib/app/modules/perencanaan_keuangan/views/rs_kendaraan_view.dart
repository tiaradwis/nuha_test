...
class RsKendaraanView extends GetView<PkKendaraanController> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        body: SafeArea(
            child:
                c.caraPembayaran.value == "Cash" ? CashWidget() : BSIWidget()));
  }
}
            ...
            children: [
              ...
              Column(
                children: [
                  ...
                  Text(
                    "Perkiraan Harga Kendaraan ${c.namaKendaraan.text}",
              ...
              RichText(
                text: TextSpan(
                  ...
                  children: [
                    const TextSpan(
                      text: 'Perencanaan dana beli kendaraan ',
                    ),
                    TextSpan(
                      text: c.danaStat,
                      style: TextStyle(
              ...
              Text(
                "Agar perencanaan dana beli kendaraan tercapai",
                style: Theme.of(context).textTheme.bodySmall!.copyWith(
                      color: grey900,
                    ),
              ),
...
class BSIWidget extends StatelessWidget {
  BSIWidget({super.key});
        ...
        Screenshot(
          ...
          child: Column(
            ...
            children: [
              ...
              Center(
                child: Column(
                  children: [
                    ...
                    Text(
                      "Harga Kendaraan ${c.namaKendaraan.text}",
                      style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                            color: grey900,
                            fontWeight: FontWeight.w600,
                          ),
              ...
              Text(
                "BSI OTO memberikan kemudahan untuk menemukan dan mendapatkan kendaraan impiannya dengan perjanjian secara syariah.",
                style: Theme.of(context).textTheme.bodySmall!.copyWith(
                      color: grey900,
                    ),
              ),
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  ...
                  color: buttonColor2.withOpacity(
                      0.2), // Warna kuning dengan tingkat kecerahan 50%
                ),
                child: Column(
                  children: [
                    SizedBox(
